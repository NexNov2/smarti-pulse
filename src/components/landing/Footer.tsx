  ...
  <footer className="bg-smarti-dark border-t border-white/10 py-8">
    <div className="max-w-6xl mx-auto px-4 md:px-8">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <span className="text-sm text-white/40">Smarti — Inteligência em Tecnologia</span>
        <span className="text-sm text-white/40">&copy; 2025 Smarti. Todos os direitos reservados.</span>
      </div>
      <p className="text-xs text-white/30 text-center mt-4">Solução própria · 8 anos de mercado</p>
    </div>
  </footer>
);
