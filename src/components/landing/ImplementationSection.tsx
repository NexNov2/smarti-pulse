...
const steps = [
  ...
  "Customização das regras de negócio",
  "Integração com seu ERP",
  "Treinamento + 1 mês de acompanhamento",
];
    ...
    <section className="bg-smarti-gray py-16 md:py-24" ref={ref}>
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <h2 className="text-3xl md:text-4xl font-bold text-smarti-blue text-center mb-4">
          Implementação a partir de 2 semanas
        </h2>
        <p className="text-base md:text-lg text-gray-600 text-center max-w-3xl mx-auto mb-12">
          Não importa como seu follow-up funciona hoje. Nós mapeamos, customizamos e entregamos a automação funcionando.
        </p>
        {/* Desktop horizontal */}
        ...
        <p className="text-sm text-gray-400 text-center mt-6">
          O prazo varia conforme a complexidade das regras de negócio e integrações. Projetos simples rodam em 2 semanas.
        </p>
      </div>
    </section>
  );
