...
const steps = [
  { title: "Conecta ao seu ERP", desc: "Integração via API, CSV ou planilha. Compatível com SAP, Oracle, Totvs e sistemas legados. Sem trocar seu software atual." },
  { title: "Identifica pedidos em aberto", desc: "O sistema importa seus pedidos, aplica suas regras de negócio e organiza automaticamente o que precisa de acompanhamento." },
  { title: "Dispara follow-ups automáticos", desc: "E-mails personalizados são enviados aos fornecedores com os pedidos pendentes, prazos e observações. Sem nenhuma ação manual." },
  {
    ...
    highlight: "O portal do fornecedor é o diferencial que elimina o vai-e-vem de e-mails. Seu fornecedor responde em cliques. Você vê a resposta instantaneamente.",
  },
  { title: "Você acompanha tudo em tempo real", desc: "Dashboard gerencial com status de todos os pedidos, alertas de atraso, histórico de interações e relatórios prontos." },
];
    ...
    <section className="bg-white py-16 md:py-24" ref={ref}>
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <h2 className="text-3xl md:text-4xl font-bold text-smarti-blue text-center mb-4">
          O Smarti Supply cobra seus fornecedores automaticamente e te dá controle total dos pedidos
        </h2>
        <p className="text-base md:text-lg text-gray-600 text-center max-w-3xl mx-auto mb-12">
          Uma plataforma que se conecta ao seu ERP, dispara follow-ups automáticos e centraliza as respostas dos fornecedores em um único painel.
        </p>
